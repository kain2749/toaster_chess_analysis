...
**Game Story:** You're playing a blunderfest against Stockfish, but you still manage to win in this mess of a game. You made several mistakes and nearly lost, but somehow you found a way to convert your advantage into victory. Your worst move was at move 36 when you played b5+ instead of Rxc2, which the engine deemed as a blunder with an eval loss of 93207 cp. The CPU also made some bad moves like Kxf2 and Qf2, but that didn't stop your relentless pursuit for victory. In the end, you checkmated Stockfish with 50.Qd5# after a long and sloppy game.
...
You (Black) played Kg8 at move 22 because you're a dumbass who can't see that your king is in danger and needs to be protected. Rf6 was the preferred move, but you chose to move your king instead of attacking with your rook. You lost significant evaluation points, which shows how much of an idiot you are for making this move.
...
You (Black) played Qa3+ at move 38 because you're a fucking moron who thinks your queen is safe on that square. Rd2 was the preferred move, but you chose to expose it to enemy pieces instead. You lost significant evaluation points, which shows how much of an idiot you are for making this move.
...
You (Black) played g5 at move 39? What are you even doing here? This is just...stupid. You're not only giving up a piece for no reason, but also allowing White to gain control of the board and push your king into a corner. Rxc2 would have been an acceptable response, but this g5 move is just a major eval loss. It's like you don't even want to win or something.
