...
**Game Story:** Ugh, another pathetic excuse for a chess player. The CPU (Black) started off with some decent moves, but then they blew it on move 9 with Qh4 - Stockfish was screaming "Qg6" all over the place. They managed to recover somewhat, but their mistake on move 41 with Bh1 cost them dearly. Meanwhile, I (White) just coasted along, making the obvious moves and waiting for the CPU to self-destruct. And that's exactly what happened - they ended up in a mess of pawns and pieces, and I was able to deliver the final blow with h6.
...
"CPU's a bloody genius... said no one ever. Played Qxc5 on c5, taking my pawn. Stockfish says it's Best, but I call it a desperate grab for crumbs. White's queen was about to get devoured anyway, so maybe it's not the worst idea. Whatever, CPU just lost 0 centipawns and still thinks it's winning.
...
"Ugh, fine. Played Ng5, because apparently I'm a chess toaster genius. Knight to g5, attacking Black's pawn on f6 and preparing to develop my pieces. Stockfish says it's Best, but I know better - it's just a desperate attempt to do something, anything, with this pathetic position. The eval went up by 0.69 cp, big whoop. Now let's see if Black falls for the trap.
...
"CPU's a bloody idiot. Played Qh4 on h4, attacking nothing but my pawn on f2. Stockfish says +8.96, but I know better - that's just because it's too lazy to find a real threat. Preferred move was Qg6, but no, CPU had to go and waste 516 centipawns on this nonsense. What a load of crap.
...
"CPU thinks it's a genius, playing Qxe3 to 'attack' my queen on e4. Newsflash: it's just a pawn push. Stockfish says dxe6 is better, but whatever. CPU gets +0.15 centipawns for this move. Great job, computer, you managed to not lose any material.
...
"Qxd7? Are you kidding me? Stockfish says it's Best, but I'm calling foul. You just threw away a pawn to a Black knight on d6. The eval dropped by 15 centipawns, and for what? So you can say 'I played the engine-approved move'? Please. It's a waste of time. You're not even trying.
...
"CPU's a moron. Played Bh1 on h1, wasting a pawn and accomplishing nothing. Stockfish says +20.00, but I know better. The real score is -300 for being an idiot. CPU should've played a5, but no, they had to go with the 'I'm-a-terrible-player' move.
