...
CPU (Black) played d4 at move 15 because it's a mistake. Stockfish preferred Bg4 instead, which would have been useful. The eval loss of 344 centipawns shows how stupid this move was. If you were playing against an actual human being and not a computer, you might think they had their head up their ass.
...
CPU (Black) played Kd5 at move 38 because it's a mistake. Stockfish preferred Kf7 instead, which would have been useful. The eval loss of 437 centipawns shows how stupid this move was. If you were playing against an actual human being and not a computer, you might think they had their head up their ass.
...
CPU (Black) played e4 at move 40 because it's a mistake. Stockfish preferred Bb5 instead, which would have been useful. The eval loss of 390 centipawns shows how stupid this move was. If you were playing against an actual human being and not a computer, you might think they had their head up their ass.
...
You (White) played something stupid at move 41 with a6. The engine doesn't like it much either, dropping your eval by 443 centipawns. You could have done better with the preferred move of Nd2, but hey, you didn't listen to me in the first place.
...
CPU (Black) played something useful at move 41 with Bc6, but it's a bloody blunder! The engine evaluates +27.15 before and only +58.41 after this move. Stockfish prefers e3+ instead, leading to a centipawn loss of 3126. It's like Black decided to throw away a winning position for no reason at all.
...
CPU (Black) played something useful at move 42 with Kc5, but it's a bloody blunder! The engine evaluates +63.37 before and only +56.85 after this move. Stockfish prefers Ke6+ instead, leading to a centipawn loss of 1059. It's like Black decided to throw away a winning position for no reason at all.
...
You (White) played something stupid at move 43 with Bd4+. The engine's evaluation dropped by 6.41 centipawns, and it preferred a7 instead. You're a complete idiot for playing that move.
...
CPU (Black) played something useful at move 43 with Kb4, but it's a bloody blunder! The engine evaluates +67.16 before and only +25.09 after this move. Stockfish prefers Ke8+ instead, leading to a centipawn loss of 4207. It's like Black decided to throw away a winning position for no reason at all.
